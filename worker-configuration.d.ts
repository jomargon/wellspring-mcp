/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 48abff959ed1279dd769a49ab53a15b6)
// Runtime types generated with workerd@1.20260714.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	AUTH_RATE_LIMIT: RateLimit;
	PUBLIC_ORIGIN: "https://wellspring.fit" | "https://wellspring-mcp-dev.jomargon.workers.dev";
	WITHINGS_CLIENT_ID: string;
	WITHINGS_CLIENT_SECRET: string;
	TOKEN_ENCRYPTION_KEY: string;
	COOKIE_ENCRYPTION_KEY: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").MyMCP>;
	USER_TOKENS: DurableObjectNamespace<import("./src/index").UserTokensDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MyMCP" | "UserTokensDO";
	}
